...
<div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" name='frm' method='post' action='/member/update.do?memberno=${memberno }' novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
            ...
            <div class="col-12">
              ...
              <input type="pw" class="form-control" id="pw" name="pw" value="${pw}" >
              <div class="invalid-feedback">
                필수 입력
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="phone" name="phone" value="${phone}" >예) 010-0000-0000
              <div class="invalid-feedback">
                필수 입력
              </div>
            </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address1' id='address1' 
                   value='' style='width: 80%;' value="${address1}"  >
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address2' id='address2' 
                   value='' style='width: 80%;' value="${address2}"  >
      </div>
    </div>   
...
<!-- ------------------------------ DAUM 우편번호 API 종료 ------------------------------ -->
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit"><a href="./update_read.do?memberno=${memberno }" class='nav-link link-dark px-2'>수정 완료</button>
        </form>
      </div>
    </div>
  </div>
