...
<c:set var="perDate" value="${contentsVO.perDate }" />
    ...
    <div class="input-group mb-3">
      ...
      <div class="card-body">
        ...
        <DIV style="width: 47%; height: 260px; float: left; margin-right: 10px; margin-bottom: 30px;">
          ...
          <br>
          <br>
          <h4 class="form-control" name="context">${context}</h4>
          <br>
           <DIV>
      ...
      <button type="button" class="btn btn-outline-secondary"><a href="./update.do?cateno=${cateno }&contentsno=${contentsVO.contentsno}"  class='nav-link link-dark px-2'>update</a></button>
    <button type="button" class="btn btn-outline-secondary"><a href="./delete.do?cateno=${cateno }&contentsno=${contentsVO.contentsno}"   class='nav-link link-dark px-2'>delete</a></button>
 <button type="button" class="btn btn-outline-secondary"><a href="./list.do?cateno=${cateno}"   class='nav-link link-dark px-2'>목록</a></button>
